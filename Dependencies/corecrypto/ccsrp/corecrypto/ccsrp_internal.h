/* Copyright (c) (2012-2021,2024) Apple Inc. All rights reserved.
 *
...
CC_INLINE size_t ccsrp_export_ccn(ccsrp_ctx_t srp, const cc_unit *a, void *bytes)
{
    ...
    return (size_t)ccn_write_uint_padded_ct_internal(ccsrp_ctx_n(srp), a, ccsrp_ctx_sizeof_n(srp), bytes);
}
...
int ccsrp_import_ccn(ccsrp_ctx_t srp, cc_unit *a, const void *bytes)
{
    ...
    return ccn_read_uint_internal(ccsrp_ctx_n(srp), a, ccsrp_ctx_sizeof_n(srp), bytes);
}
...
int ccsrp_import_ccn_with_len(ccsrp_ctx_t srp, cc_unit *a, size_t len, const void *bytes)
{
    ...
    return ccn_read_uint_internal(ccsrp_ctx_n(srp), a, len, bytes);
}
...
CC_INLINE size_t ccsrp_private_key_bitlen(ccsrp_ctx_t srp)
{
    ...
    size_t nbits_actual = ccn_bitlen_internal(ccsrp_ctx_n(srp), ccsrp_ctx_private(srp));
