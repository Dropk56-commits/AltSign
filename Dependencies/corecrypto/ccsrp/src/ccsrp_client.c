/* Copyright (c) (2012-2022,2024) Apple Inc. All rights reserved.
 *
...
int alt_ccsrp_client_start_authentication(ccsrp_ctx_t srp, struct ccrng_state *rng, void *A_bytes)
{
...
bool alt_ccsrp_client_verify_session(ccsrp_ctx_t srp, const uint8_t *HAMK_bytes)
{
    CC_ENSURE_DIT_ENABLED_WITH_SB

    int cmp = cc_cmp_safe_internal(ccsrp_ctx_M_HAMK_size(srp), ccsrp_ctx_HAMK(srp), HAMK_bytes);
