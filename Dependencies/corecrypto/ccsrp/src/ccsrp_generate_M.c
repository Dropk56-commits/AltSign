                         ...
                         const cc_unit *B)
{
    ...
    ccdigest_internal(di, strlen(username), username, H_I);
    ccdigest_init_internal(di, ctx);
    ccdigest_update_internal(di, ctx, hashlen, H_xor);
    ccdigest_update_internal(di, ctx, hashlen, H_I);
    ...
    ccdigest_update_internal(di, ctx, ccsrp_get_session_key_length(srp), ccsrp_ctx_K(srp));
