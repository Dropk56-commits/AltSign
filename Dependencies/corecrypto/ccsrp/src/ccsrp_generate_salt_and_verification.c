...
static int ccsrp_generate_verifier_internal(ccsrp_ctx_t srp,
                                            const char *username,
                                            size_t password_len,
                                            const void *password,
                                            size_t salt_len,
                            ...
                            void *verifier)
{
    ...
    return ccsrp_generate_verifier_internal(srp, username, password_len, password, salt_len, salt, verifier);
}
