                         ...
                         bool skip_leading_zeroes)
{
    ...
    ccdigest_internal(ccsrp_ctx_di(srp), ccsrp_ctx_sizeof_n(srp) - offset, buf + offset, dest);
                                ...
                                bool skip_leading_zeroes)
{
    ...
    ccdigest_update_internal(ccsrp_ctx_di(srp), ctx, ccsrp_ctx_sizeof_n(srp) - offset, buf + offset);
                             ...
                             bool skip_leading_zeroes)
{
    ...
    ccn_read_uint_internal(ccsrp_ctx_n(srp), r, len, hash);
