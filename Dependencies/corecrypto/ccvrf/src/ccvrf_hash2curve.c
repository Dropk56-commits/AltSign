                                 ...
                                 const size_t alphalen, uint8_t *H_string)
{
    ...
    ccdigest_update_internal(di, ctx, sizeof(suite), &suite);
    ccdigest_update_internal(di, ctx, sizeof(one), &one);
    ccdigest_update_internal(di, ctx, sizeof(PK_string), PK_string);
    ccdigest_update_internal(di, ctx, alphalen, alpha);
