/* Copyright (c) (2010-2012,2015-2019,2024) Apple Inc. All rights reserved.
 *
                        ...
                        ccecb_ctx * skey)
{
    ...
    int status = 0;
    CC_TEST_DISABLE_DIT_ASSERTS_WITH_RESTORE(dit_state);
    if (!cc_cmp_safe_internal(8, key, key+8) ||
        !cc_cmp_safe_internal(8, key, key+16) ||
        !cc_cmp_safe_internal(8, key+8, key+16)) {
        status = -1;
    }
    CC_TEST_RESTORE_DIT_ASSERTS(dit_state);
