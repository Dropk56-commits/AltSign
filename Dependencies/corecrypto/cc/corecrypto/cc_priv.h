...
#elif __has_builtin(__builtin___memcpy_chk) && !defined(_MSC_VER) && !CC_ARM_ARCH_6M
...
#elif __has_builtin(__builtin___memmove_chk) && !defined(_MSC_VER) && !CC_ARM_ARCH_6M
...
#elif __has_builtin(__builtin___memset_chk) && !defined(_MSC_VER) && !CC_ARM_ARCH_6M
