/* Copyright (c) (2019,2020,2023,2024) Apple Inc. All rights reserved.
 *
...
#define CC_FAULT_CANARY_EQUAL_INTERNAL(_a_, _b_) (cc_cmp_safe_internal(CC_FAULT_CANARY_SIZE, _a_, _b_) == 0)
