...
#define CC_HAS_DIT() (0)
    ...
    #define CC_HAS_SHA512() cc_cpu_supports(kHasFeatSHA512)
    #define CC_HAS_SHA3() cc_cpu_supports(kHasFeatSHA3)
    #define CC_HAS_DIT() cc_cpu_supports(kHasFeatDIT)
    #define CC_HAS_SB() cc_cpu_supports(kHasFeatSB)
#else
    #define CC_HAS_SHA512() (CC_ARM_FEATURE_SHA512)
    #define CC_HAS_SHA3() (0)
    #define CC_HAS_DIT() (0)
