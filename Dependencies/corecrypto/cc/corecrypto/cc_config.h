...
#define CC_SMALL_CODE 0
 ...
 #if (CC_USE_L4 || CC_RTKIT || CC_RTKITROM || CC_USE_SEPROM || CC_EFI || CC_LINUX || defined(_WIN32) || CC_BASEBAND || CC_ARM_ARCH_6M)
  #define CC_DARWIN 0
 #elif CC_TXM
  #define CC_DARWIN 0
 #elif CC_SPTM
...
// Check for extended asm support.
#if !defined(CC_HAS_EXTENDED_ASM)
 #if defined(__GNUC__)
  #define CC_HAS_EXTENDED_ASM 1
 #else
  #define CC_HAS_EXTENDED_ASM 0
 #endif
#endif
...
//-(3) Intel 32/64
 ...
 #define CCSHA256_ARMV6M_ASM    0
//-(4) ARMv6-M
#elif CC_ARM_ARCH_6M && CC_USE_ASM
 #define CCN_ADD_ASM            0
 #define CCN_SUB_ASM            0
 #define CCN_MUL_ASM            0
 #define CCN_ADDMUL1_ASM        0
...
#if defined(INTERNAL_SDK) && INTERNAL_SDK
...
#if defined(__arm64__) && !CC_USE_L4 && !CC_USE_SEPROM && !CC_IBOOT && !CC_TXM
  #define CC_DIT_WITH_SB_MAYBE_SUPPORTED 1
#else
  #define CC_DIT_WITH_SB_MAYBE_SUPPORTED 0
#endif

#ifndef CC_BEGIN_DECLS
