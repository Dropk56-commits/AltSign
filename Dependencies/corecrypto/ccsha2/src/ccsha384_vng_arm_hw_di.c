...
static void ccsha384_vng_arm_hw_compress(ccdigest_state_t c, size_t num, const void *p)
{
    AccelerateCrypto_SHA512_compress_hwassist((uint64_t*) c, num, p);
}

const struct ccdigest_info ccsha384_vng_arm_hw_di = {
    ...
    .compress = ccsha384_vng_arm_hw_compress,
    .final = ccsha512_final,
    .impl = CC_IMPL_SHA384_VNG_ARM_HW,
};
