...
static void ccsha512_256_vng_arm_hw_compress(ccdigest_state_t c, size_t num, const void *p)
{
    AccelerateCrypto_SHA512_compress_hwassist((uint64_t*) c, num, p);
}

const struct ccdigest_info ccsha512_256_vng_arm_hw_di = {
    ...
    .compress = ccsha512_256_vng_arm_hw_compress,
