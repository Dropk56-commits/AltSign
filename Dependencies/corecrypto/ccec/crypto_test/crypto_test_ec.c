...
static void ccec_cczp_mod_prime_tests(ccec_const_cp_t cp)
{
    ...
    // A few random tests.
    CC_TEST_DISABLE_DIT_ASSERTS // These tests use `_ws` variants which expect DIT enabled
...
static void ccec_affinify_points_tests(ccec_const_cp_t cp)
{
    ...
    CC_TEST_DISABLE_DIT_ASSERTS // These _ws functions assume DIT is enabled
