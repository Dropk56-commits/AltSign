                                      ...
                                      ccec_const_affine_point_t base)
{
    ...
    for (size_t i = ccn_bitlen_internal(n, d) - 1; i > 0; i--) {
                                                ...
                                                uint8_t *sk)
{
    ...
    ccn_write_uint_padded_internal(n, x, ccec_cp_prime_size(cp), sk);
                                         ...
                                         struct ccrng_state *rng)
{
    ...
    cc_require_action(cc_cmp_safe_internal(shared_key_size, shared_key1, shared_key2) == 0, errOut, rv = CCEC_GENERATE_KEY_CONSISTENCY);
