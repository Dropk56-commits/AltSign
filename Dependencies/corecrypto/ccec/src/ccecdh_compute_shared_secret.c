                                    ...
                                    struct ccrng_state *masking_rng)
{
    ...
    *computed_shared_secret_len = 0;
    ...
    size_t p_len = ccn_write_uint_size_internal(ccec_cp_n(cp), ccec_cp_p(cp));
    ...
    ccn_write_uint_padded_ct_internal(ccec_cp_n(cp), ccec_point_x(r, cp), p_len, computed_shared_secret);
