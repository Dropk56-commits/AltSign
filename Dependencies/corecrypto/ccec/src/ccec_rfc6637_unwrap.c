                                      ...
                                      const void *wrapped_key)
{
    ...
    ccecb_init_internal(ecbmode, ecb, unwrap->pgp->keysize, hash);
    ...
    res = ccwrap_auth_decrypt_withiv_internal(ecbmode, ecb, wrapped_size, &wkey[2 + wkey_size + 1], &m_size, m, &iv);
