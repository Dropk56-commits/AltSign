/* Copyright (c) (2011,2012,2015,2016,2019,2021,2022,2024) Apple Inc. All rights reserved.
 *
                             ...
                             ccec_full_ctx_t key)
{
    ...
    rv = ccn_read_uint_internal(ccec_cp_n(cp), ccec_ctx_k(key), ccec_cp_order_size(cp), in + ccec_x963_export_size_cp(0, cp));
    cc_require(rv == CCERR_OK, errOut);
