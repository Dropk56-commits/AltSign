/* Copyright (c) (2011,2015,2016,2018,2019,2021,2024) Apple Inc. All rights reserved.
 *
...
int ccec_make_pub(size_t nbits,
    ...
    if ((0 != ccn_read_uint_public_value(ccec_cp_n(cp), ccec_ctx_x(key), xlength, x))) {
        return CCERR_INTERNAL;
    }

    if ((0 != ccn_read_uint_public_value(ccec_cp_n(cp), ccec_ctx_y(key), ylength, y))) {
        return CCERR_INTERNAL;
    }
