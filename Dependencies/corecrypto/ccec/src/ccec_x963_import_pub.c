/* Copyright (c) (2010-2012,2015,2016,2019-2021,2023,2024) Apple Inc. All rights reserved.
 *
...
int ccec_x963_import_pub_ws(cc_ws_t ws, ccec_const_cp_t cp, size_t in_len, const uint8_t *in, ccec_pub_ctx_t key)
{
    ...
    CC_TEST_DISABLE_DIT_ASSERTS_WITH_RESTORE(dit_assert_state)
    ...
    errOut:
        CC_TEST_RESTORE_DIT_ASSERTS(dit_assert_state)
        CC_FREE_BP_WS(ws, bp);
        return rv;
}
