/* Copyright (c) (2018,2019,2021,2023,2024) Apple Inc. All rights reserved.
 *
...
int ccrng_uniform_internal(struct ccrng_state *rng, uint64_t bound, uint64_t *rand)
{
...
int ccrng_uniform(struct ccrng_state *rng, uint64_t bound, uint64_t *rand)
{
    ...
    return ccrng_uniform_internal(rng, bound, rand);
}
