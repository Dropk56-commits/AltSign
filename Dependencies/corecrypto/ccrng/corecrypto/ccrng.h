/* Copyright (c) (2010-2020,2022-2024) Apple Inc. All rights reserved.
 *
...
/*!
 ...
 In SEP, kernel space, and user space, we guarantee 256-bit security;
 contact us regarding other environments.

 The RNG may be a TRNG if one is available. Otherwise, it is
