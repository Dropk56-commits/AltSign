# Copyright (c) (2011-2017,2019-2021,2024) Apple Inc. All rights reserved.
#
...
#else
    ldr     wRCON, [RCON, _Rcon@GOTPAGEOFF]
    ldr     wsubbyte, [subbyte, _AESSubBytesWordTable@GOTPAGEOFF]
#endif
#else
	push	{r4-r7,lr}
