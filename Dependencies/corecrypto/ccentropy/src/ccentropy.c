                       ...
                       void *seed)
{
    ...
    return ccentropy_get_seed_internal(ctx, seed_nbytes, seed);
}
                          ...
                          bool *seed_ready)
{
    ...
    return ccentropy_add_entropy_internal(ctx, entropy_nsamples, entropy_nbytes, entropy, seed_ready);
}
