/* Copyright (c) (2011-2016,2018,2019,2021,2022,2024) Apple Inc. All rights reserved.
 *
                                   ...
                                   size_t parameter_data_len, const uint8_t *parameter_data)
{
    ...
    ccn_zero(n, DB);
    ccdigest_internal(di, parameter_data_len, parameter_data, (uint8_t *)DB);
                                ...
                                size_t parameter_data_len, const uint8_t *parameter_data)
{
    ...
    return ccrsa_oaep_encode_parameter_internal(di, rng, r_size, r, message_len, message, parameter_data_len, parameter_data);
}
