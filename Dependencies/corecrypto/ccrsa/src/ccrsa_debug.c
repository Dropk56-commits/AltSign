/* Copyright (c) (2015,2016,2018-2021,2024) Apple Inc. All rights reserved.
 *
...
void ccrsa_dump_public_key(ccrsa_pub_ctx_t key) {
    ...
    // CC_UNUSED because cc_printf is defined empty for some targets.
    CC_UNUSED cc_size nbits = ccrsa_pubkeylength(key);
