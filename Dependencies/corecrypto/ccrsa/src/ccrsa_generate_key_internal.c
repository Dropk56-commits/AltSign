/* Copyright (c) (2011-2022,2024) Apple Inc. All rights reserved.
 *
                                   ...
                                   struct ccrng_state *rng_mr)
{
    ...
    int rv = ccn_read_uint_internal(n, ccrsa_ctx_e(pubk), e_nbytes, e);
    ...
    cc_require_action(ccn_bitlen_internal(n, ccrsa_ctx_e(pubk)) > 1, errOut, rv = CCRSA_INVALID_INPUT);
