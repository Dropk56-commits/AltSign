/* Copyright (c) (2011,2012,2014-2016,2018-2021,2024) Apple Inc. All rights reserved.
 *
                          ...
                          bool *valid)
{
    ...
    *valid = false;
    ...
    int status = ccrsa_verify_pkcs1v15_digest_ws(ws, key, oid, digest_len, digest, sig_len, sig, NULL);
                                 ...
                                 cc_fault_canary_t fault_canary_out)
{
    ...
    return ccrsa_verify_pkcs1v15_digest_ws(ws,
                                           key,
                                           di->oid,
                              ...
                              cc_fault_canary_t fault_canary_out)
{
    ...
    CC_DECL_WORKSPACE_OR_FAIL(ws, CCRSA_VERIFY_PKCS1V15_MSG_WORKSPACE_N(ccrsa_ctx_n(key)));
    int rv = ccrsa_verify_pkcs1v15_msg_ws(ws,
                                          key,
                                          di,
                                          msg_len, msg,
                                          sig_len, sig,
