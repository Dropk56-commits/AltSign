...
uint8_t *ccder_encode_rsa_priv_internal(const ccrsa_full_ctx_t key, const uint8_t *der, uint8_t *der_end) {
...
uint8_t *ccder_encode_rsa_priv(const ccrsa_full_ctx_t key, const uint8_t *der, uint8_t *der_end) {
    ...
    return ccder_encode_rsa_priv_internal(key, der, der_end);
}
