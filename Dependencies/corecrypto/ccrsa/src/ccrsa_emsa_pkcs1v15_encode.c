...
int ccrsa_emsa_pkcs1v15_encode_internal(size_t emlen, uint8_t *em, size_t dgstlen, const uint8_t *dgst, const uint8_t *oid)
{
...
int ccrsa_emsa_pkcs1v15_encode(size_t emlen, uint8_t *em, size_t dgstlen, const uint8_t *dgst, const uint8_t *oid)
{
    ...
    return ccrsa_emsa_pkcs1v15_encode_internal(emlen, em, dgstlen, dgst, oid);
}
