/* Copyright (c) (2011-2013,2015-2019,2021,2024) Apple Inc. All rights reserved.
 *
                                        ...
                                        struct ccrng_state *rng)
{
    ...
    rv = ccrsa_sign_pkcs1v15_msg_blinded_ws(ws, rng, full_key, ccsha256_di(), 0, &dummy, &siglen, sig);
    cc_require(rv == CCERR_OK, errOut);

    rv = ccrsa_verify_pkcs1v15_msg_ws(ws, pub_key, ccsha256_di(), 0, &dummy, siglen, sig, NULL);
    ...
    cc_require_action(ccn_cmp_internal(n, s, r) != 0, errOut, rv = CCERR_PARAMETER);
    ...
    cc_require_action(ccn_cmp_internal(n, t, s) == 0, errOut, rv = CCERR_PARAMETER);
