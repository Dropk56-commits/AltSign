/* Copyright (c) (2011,2013,2015,2018-2022,2024) Apple Inc. All rights reserved.
 *
                                  ...
                                  size_t s_size, const uint8_t *s)
{
    ...
    *r_size = m_size;
    ...
    int rv = ccrsa_eme_pkcs1v15_encode_internal(rng, m_size, tmp, s_size, s);
    if (rv) {
        goto errOut;
    }
    ...
    rv = ccn_write_uint_padded_ct_internal(n, tmp, m_size, r);
    if (rv > 0) {
        rv = CCERR_OK;
    }
