...
int ccdrbg_init_internal(const struct ccdrbg_info *info,
            ...
            size_t psLength, const void* ps)
{
    ...
    return ccdrbg_init_internal(info, drbg, entropyLength, entropy, nonceLength, nonce, psLength, ps);
}

int ccdrbg_reseed_internal(const struct ccdrbg_info *info,
                           struct ccdrbg_state *drbg,
                           size_t entropyLength, const void *entropy,
       ...
       size_t additionalLength, const void *additional)
{
    ...
    return ccdrbg_reseed_internal(info, drbg, entropyLength, entropy, additionalLength, additional);
}

int ccdrbg_generate_internal(const struct ccdrbg_info *info,
                             struct ccdrbg_state *drbg,
         ...
         size_t additionalLength, const void *additional)
{
    ...
    return ccdrbg_generate_internal(info, drbg, dataOutLength, dataOut, additionalLength, additional);
}
