/* Copyright (c) (2016-2021,2024) Apple Inc. All rights reserved.
 *
                          ...
                          const cc_unit *e)
{
    ...
    cc_require(ccn_cmp_internal(np, s, ccdh_gp_prime(gp)) < 0, errOut);
    cc_require(ccn_cmpn_internal(ccn_nof(ebitlen), e, np, ccdh_gp_prime(gp)) < 0, errOut);
