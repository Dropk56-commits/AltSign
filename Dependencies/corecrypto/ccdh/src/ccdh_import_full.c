/* Copyright (c) (2011,2015-2019,2021,2024) Apple Inc. All rights reserved.
 *
                     ...
                     ccdh_full_ctx_t key)
{
    ...
    if ((ccn_read_uint_internal(ccdh_gp_n(gp), x, in_priv_len, in_priv)))
        return CCDH_INVALID_INPUT;

    if (ccn_cmp_internal(ccdh_gp_n(gp), x, cczp_prime(ccdh_gp_zp(gp))) >= 0)
