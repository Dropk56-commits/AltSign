/* Copyright (c) (2011,2014-2022,2024) Apple Inc. All rights reserved.
 *
                                  ...
                                  struct ccrng_state *blinding_rng)
{
    ...
    if (ccdh_valid_shared_secret(n, r, gp)) {
        *computed_shared_secret_len = ccn_write_uint_size_internal(n, r);
        ccn_write_uint_internal(n, r, *computed_shared_secret_len, computed_shared_secret);
    } else {
