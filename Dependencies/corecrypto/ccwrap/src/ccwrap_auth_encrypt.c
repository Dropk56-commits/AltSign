/* Copyright (c) (2012,2014-2016,2018,2019,2021,2024) Apple Inc. All rights reserved.
 *
                                 ...
                                 void *out)
{
    ...
    return ccwrap_auth_encrypt_withiv_internal(ecb_mode,
                                               ecb_key,
                                               nbytes,
                                               in,
                                               obytes,
                        ...
                        void *out)
{
    ...
    return ccwrap_auth_encrypt_internal(ecb_mode, ecb_key, nbytes, in, obytes, out);
}
