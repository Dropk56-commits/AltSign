...
#define cczp_nof_n(_n_) (ccn_nof_size(sizeof(struct cczp_hd)) + cczp_payload_nof_n(_n_))
...
/*! @function cczp_is_quadratic_residue_ws
 ...
 @return 0 if a is a quadratic residue, -1 otherwise.
 */
CC_NONNULL_ALL
...
/*! @function cczp_mm_init_ws
 ...
 @param zp  Multiplicative group Z/(p)
 @param n   Size of p
 @param p   Prime p (optional, can be NULL)
