...
static void test_cczp_power_fns(void)
{
    ...
    // All of these call workspace functions which (often) assume that 
    // DIT is enabled so we'll enable it here. We could fake it with
    // `CC_TEST_DISABLE_DIT_ASSERTS` but that complicates some
    // internal functions (mainly *restoring* previous "are nested
    // DIT checks enabled?).
    ...
    ccn_seti(n, e, 1);
    cczp_power_ws(ws, zp, r, s, ccn_bitlen_internal(n, e), e);
    ok_ccn_cmp_internal(n, r, s, "cczp_power when e = 1");
    cczp_mm_power_ws(ws, zp, r, s, ccn_bitlen_internal(n, e), e);
    ok_ccn_cmp_internal(n, r, s, "cczp_mm_power when e = 1");
    cczp_power_fast_ws(ws, zp, r, s, e);
    ok_ccn_cmp_internal(n, r, s, "cczp_power_fast when e = 1");
    cczp_mm_power_fast_ws(ws, zp, r, s, e);
    ok_ccn_cmp_internal(n, r, s, "cczp_mm_power_fast when e = 1");
    (void)cczp_power_blinded_ws(ws, zp, r, s, ccn_bitlen_internal(n, e), e, global_test_rng);
    ok_ccn_cmp_internal(n, r, s, "cczp_power_blinded_ws when e = 1");

    ccn_seti(n, e, 2);
    ccn_seti(n, t, 4);
    cczp_power_ws(ws, zp, r, s, ccn_bitlen_internal(n, e), e);
    ok_ccn_cmp_internal(n, r, t, "cczp_power when e = 2");
    cczp_mm_power_ws(ws, zp, r, s, ccn_bitlen_internal(n, e), e);
    ok_ccn_cmp_internal(n, r, t, "cczp_mm_power when e = 2");
    cczp_power_fast_ws(ws, zp, r, s, e);
    ok_ccn_cmp_internal(n, r, t, "cczp_power_fast when e = 2");
    cczp_mm_power_fast_ws(ws, zp, r, s, e);
    ok_ccn_cmp_internal(n, r, t, "cczp_mm_power_fast when e = 2");
    (void)cczp_power_blinded_ws(ws, zp, r, s, ccn_bitlen_internal(n, e), e, global_test_rng);
    ok_ccn_cmp_internal(n, r, t, "cczp_power_blinded_ws when e = 2");

    ccn_seti(n, e, 4);
    ccn_seti(n, t, 16);
    cczp_power_ws(ws, zp, r, s, ccn_bitlen_internal(n, e), e);
    ok_ccn_cmp_internal(n, r, t, "cczp_power when e = 4");
    cczp_mm_power_ws(ws, zp, r, s, ccn_bitlen_internal(n, e), e);
    ok_ccn_cmp_internal(n, r, t, "cczp_mm_power when e = 4");
    cczp_power_fast_ws(ws, zp, r, s, e);
    ok_ccn_cmp_internal(n, r, t, "cczp_power_fast when e = 4");
    cczp_mm_power_fast_ws(ws, zp, r, s, e);
    ok_ccn_cmp_internal(n, r, t, "cczp_mm_power_fast when e = 4");
    (void)cczp_power_blinded_ws(ws, zp, r, s, ccn_bitlen_internal(n, e), e, global_test_rng);
    ok_ccn_cmp_internal(n, r, t, "cczp_power_blinded_ws when e = 4");

    cczp_power_ws(ws, zp, r, s, ccn_bitlen_internal(n, p), e);
    ok_ccn_cmp_internal(n, r, t, "cczp_power when e = 4 with bit length |p|");
    cczp_mm_power_ws(ws, zp, r, s, ccn_bitlen_internal(n, p), e);
    ok_ccn_cmp_internal(n, r, t, "cczp_mm_power when e = 4 with bit length |p|");
    (void)cczp_power_blinded_ws(ws, zp, r, s, ccn_bitlen_internal(n, p), e, global_test_rng);
    ok_ccn_cmp_internal(n, r, t, "cczp_power_blinded_ws when e = 4 with bit length |p|");

    ccn_add_ws(ws, n, t, s, p);
    isnt(cczp_power_ws(ws, zp, r, t, ccn_bitlen_internal(n, e), e), 0, "cczp_power when base > p");
    isnt(cczp_mm_power_ws(ws, zp, r, t, ccn_bitlen_internal(n, e), e), 0, "cczp_mm_power when base > p");
    isnt(cczp_power_blinded_ws(ws, zp, r, t, ccn_bitlen_internal(n, e), e, global_test_rng), 0, "cczp_power_blinded_ws when base > p");
...
static void test_cczp_power_fns_randomized(cczp_const_t zp)
{
    ...
    for (int i = 0; i < NUM_RANDOM_POWER_TESTS; i++) {
        ...
        is(cczp_power_ws(ws, zp, r0, b, ccn_bitlen_internal(n, e), e), 0, "cczp_power randomized");
        is(cczp_mm_power_ws(ws, zp, r1, b, ccn_bitlen_internal(n, e), e), 0, "cczp_mm_power randomized");
        ...
        is(cczp_power_blinded_ws(ws, zp, r4, b, ccn_bitlen_internal(n, e), e, global_test_rng), 0, "cczp_power_blinded_ws randomized");

        ok_ccn_cmp_internal(n, r0, r1, "cczp_power != cczp_mm_power");
        ok_ccn_cmp_internal(n, r0, r2, "cczp_power != cczp_power_fast");
        ok_ccn_cmp_internal(n, r0, r3, "cczp_power != cczp_mm_power_fast");
        ok_ccn_cmp_internal(n, r0, r4, "cczp_power != cczp_power_blinded_ws");
...
static int test_cczp_sqrt_single(cc_unit *r, cc_unit q, size_t p_len, const uint8_t *p)
{
    ...
    cczp_decl_n(n, zp);
    CCZP_N(zp) = n;
    ccn_read_uint_internal(n, CCZP_PRIME(zp), p_len, p);
...
{
    CC_ENSURE_DIT_ENABLED_WITH_SB // cczp_sqrt expects DIT to be enabled
    ...
    for (int i = 0; i < NUM_RANDOM_SQRT_TESTS; i++) {
        ...
        is(ccn_cmp_internal(n, r1, x), 0, "SQRT FAILURE");
    }
}
...
{
    CC_ENSURE_DIT_ENABLED_WITH_SB // cczp_is_quadratic_residue_ws expects DIT to be enabled
    ...
    is(res, 0, "QR test failure: x = 23 is a QR");

    ccn_seti(n, x, 235); // 235 is not a quadratic residue
    res = cczp_is_quadratic_residue_ws(ws, zp, x);
    isnt(res, 0, "QR test failure: x = 235 is not a QR");

    ccn_set(n, x, p);
    res = cczp_is_quadratic_residue_ws(ws, zp, x);
    isnt(res, 0, "QR test failure: x = p is not a QR");
