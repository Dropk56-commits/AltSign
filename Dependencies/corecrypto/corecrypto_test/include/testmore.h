/* Copyright (c) (2012,2014-2020,2024) Apple Inc. All rights reserved.
 *
...
#define ccn_cmp_print_internal(_NLEN_, _P1_, _P2_) \
({ \
int _this = ccn_cmp_internal(_NLEN_, (_P1_), (_P2_)); \
if(_this!=0) {ccn_lprint(_NLEN_,"Compare: ",(_P1_)); \
              ccn_lprint(_NLEN_,"    and: ",(_P2_));} \
_this; \
})

#define ok_ccn_cmp_internal(_NLEN_, _P1_, _P2_, args...) ok(ccn_cmp_print_internal(_NLEN_, _P1_, _P2_)==0, args)
