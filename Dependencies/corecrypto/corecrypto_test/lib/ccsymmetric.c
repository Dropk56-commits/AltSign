/* Copyright (c) (2012,2014-2016,2018-2020,2024) Apple Inc. All rights reserved.
 *
                               ...
                               cc_symmetric_context_p ctx)
{
    switch (cm->mode) {
        case cc_ModeXTS: {
            ...
            int status = cm->ciphermode.xts->init(cm->ciphermode.xts, ctx->ctx.xts, keylen, key, tweak);
