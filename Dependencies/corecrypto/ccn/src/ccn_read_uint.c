/* Copyright (c) (2010,2011,2015,2018,2019,2021,2024) Apple Inc. All rights reserved.
 *
...
int ccn_read_uint_public_value(cc_size n, cc_unit *r, size_t data_nbytes, const uint8_t *data)
{
    int rc = 0;
...
int ccn_read_uint_internal(cc_size n, cc_unit *r, size_t data_nbytes, const uint8_t *data)
{
    CC_ASSERT_DIT_IS_ENABLED
    
    return ccn_read_uint_public_value(n, r, data_nbytes, data);
}
...
int ccn_read_uint(cc_size n, cc_unit *r, size_t data_nbytes, const uint8_t *data)
{
    ...
    return ccn_read_uint_internal(n, r, data_nbytes, data);
}
