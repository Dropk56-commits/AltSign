 ...
 */
void cchmac_init_internal(const struct ccdigest_info *di, cchmac_ctx_t hc,
    ...
    if (key_len <= di->block_size) {
        ...
        ccdigest_init_internal(di, cchmac_digest_ctx(di, hc));
        ccdigest_update_internal(di, cchmac_digest_ctx(di, hc), key_len, key);
...
void cchmac_init(const struct ccdigest_info *di, cchmac_ctx_t hc,
    ...
    return cchmac_init_internal(di, hc, key_len, key_data);
}
