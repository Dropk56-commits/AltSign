/* Copyright (c) (2010,2011,2015,2017-2019,2021,2024) Apple Inc. All rights reserved.
 *
...
void cchmac_final_internal(const struct ccdigest_info *di, cchmac_ctx_t hc,
                  unsigned char *mac) {
...
void cchmac_final(const struct ccdigest_info *di, cchmac_ctx_t hc,
    ...
    return cchmac_final_internal(di, hc, mac);
}
