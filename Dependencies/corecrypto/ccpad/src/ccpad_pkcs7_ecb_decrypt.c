/* Copyright (c) (2011,2012,2014,2015,2019,2021,2022,2024) Apple Inc. All rights reserved.
 *
...
size_t ccpad_pkcs7_ecb_decrypt(const struct ccmode_ecb *ecb, ccecb_ctx *ecb_key,
    ...
    pad_size = ccpad_pkcs7_decode_internal(block_size,plain+((nblocks-1)*block_size));
