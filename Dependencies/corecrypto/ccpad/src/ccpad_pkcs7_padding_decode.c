/* Copyright (c) (2014,2015,2019,2021,2022,2024) Apple Inc. All rights reserved.
 *
...
size_t ccpad_pkcs7_decode_internal(const size_t block_size, const uint8_t* last_block) {
...
size_t ccpad_pkcs7_decode(const size_t block_size, const uint8_t* last_block) {
    ...
    return ccpad_pkcs7_decode_internal(block_size, last_block);
}
