/* Copyright (c) (2014-2016,2019,2021,2024) Apple Inc. All rights reserved.
 *
...
bool
ccder_blob_encode_eckey_internal(ccder_blob *to,
                        ...
                        size_t pub_byte_size, const uint8_t *cc_sized_by(pub_byte_size) pub_key)
{
    ...
    return ccder_blob_encode_eckey_internal(to, priv_byte_size, priv_key, oid, pub_byte_size, pub_key);
}
