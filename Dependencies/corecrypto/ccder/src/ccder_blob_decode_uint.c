/* Copyright (c) (2012,2015,2016,2019,2021,2022,2024) Apple Inc. All rights reserved.
 *
...
static bool ccder_blob_decode_uint_range(ccder_read_blob *int_blob, cc_size n, cc_unit *cc_counted_by(n) r)
{
    ...
    if (ccn_read_uint_public_value(n, r, ccder_blob_size(*int_blob), int_blob->der) != CCERR_OK) {
        return false;
    }
    return true;
}
