/* Copyright (c) (2012,2015,2016,2019,2021,2024) Apple Inc. All rights reserved.
 *
...
ccder_blob_decode_eckey(ccder_read_blob *from, uint64_t *version,
    ...
    return ccder_blob_decode_eckey_internal(from, version, priv_key_byte_size, priv_key, oid, pub_key_byte_size, pub_key, pub_key_bit_count);
}
