/* Copyright (c) (2019,2021,2022,2024) Apple Inc. All rights reserved.
 *
...
uint8_t *ccder_encode_eckey_internal(size_t priv_size,
...
const uint8_t *ccder_decode_eckey_internal(uint64_t *version,
                                           size_t *priv_size,
                                           const uint8_t **priv_key,
                                           ccoid_t *oid,
                                           size_t *pub_size,
...
bool ccder_blob_decode_eckey_internal(ccder_read_blob *from, uint64_t *version, size_t *priv_key_byte_size, const uint8_t *cc_sized_by(*priv_key_byte_size) *priv_key, ccoid_t *oid, size_t *pub_key_byte_size, const uint8_t *cc_sized_by(*pub_key_byte_size) *pub_key, size_t *pub_key_bit_count);

CC_NONNULL((1, 3)) CC_NODISCARD
bool ccder_blob_encode_eckey_internal(ccder_blob *into, size_t priv_byte_size, const uint8_t *cc_sized_by(priv_byte_size) priv_key, ccoid_t oid, size_t pub_byte_size, const uint8_t *cc_sized_by(pub_byte_size) pub_key);
