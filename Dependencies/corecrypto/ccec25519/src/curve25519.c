                                    ...
                                    struct ccrng_state *rng)
{
    ...
    if (cc_cmp_safe_internal(32, out, zeros) == 0) {
        rv = CCERR_PARAMETER;
    }
...
int cccurve25519_assumes_dit_internal(ccec25519key out, const ccec25519secretkey sk, const ccec25519base base)
{
    CC_ASSERT_DIT_IS_ENABLED
...
int cccurve25519(ccec25519key out, const ccec25519secretkey sk, const ccec25519base base)
{
    ...
    return cccurve25519_assumes_dit_internal(out, sk, base);
}

int cccurve25519_make_priv_internal(struct ccrng_state *rng, ccec25519secretkey sk)
{
    CC_ASSERT_DIT_IS_ENABLED
...
int cccurve25519_make_priv(struct ccrng_state *rng, ccec25519secretkey sk)
{
    ...
    return cccurve25519_make_priv_internal(rng, sk);
}

int cccurve25519_make_pub_with_rng_internal(struct ccrng_state *rng, ccec25519pubkey pk, const ccec25519secretkey sk)
{
    CC_ASSERT_DIT_IS_ENABLED
...
int cccurve25519_make_pub_with_rng(struct ccrng_state *rng, ccec25519pubkey pk, const ccec25519secretkey sk)
{
    ...
    return cccurve25519_make_pub_with_rng_internal(rng, pk, sk);
}

int cccurve25519_make_pub_internal(ccec25519pubkey pk, const ccec25519secretkey sk)
{
    CC_ASSERT_DIT_IS_ENABLED
...
int cccurve25519_make_key_pair_internal(struct ccrng_state *rng, ccec25519pubkey pk, ccec25519secretkey sk)
{
    CC_ASSERT_DIT_IS_ENABLED
    
    int rv = cccurve25519_make_priv_internal(rng, sk);
    cc_require_or_return(rv == CCERR_OK, rv);
...
int cccurve25519_make_key_pair(struct ccrng_state *rng, ccec25519pubkey pk, ccec25519secretkey sk)
{
    ...
    return cccurve25519_make_key_pair_internal(rng, pk, sk);
}
