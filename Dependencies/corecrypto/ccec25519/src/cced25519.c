/* Copyright (c) (2014-2019,2023,2024) Apple Inc. All rights reserved.
 *
                                 ...
                                 const uint8_t *cc_sized_by(msg_nbytes) msg)
{
    ...
    ccdigest_update_internal(di, dc, data1_nbytes, data1);
    ccdigest_update_internal(di, dc, data2_nbytes, data2);
    ccdigest_update_internal(di, dc, msg_nbytes, msg);
