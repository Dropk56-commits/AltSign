                                                     ...
                                                     const ccec25519pubkey pk)
{
    ...
    cc_require_or_return(ccn_cmp_internal(n, y, cczp_prime(zp)) < 0, rv);
                               ...
                               const ccec25519pubkey pk)
{
    ...
    cc_require(ccn_cmp_internal(n, s, cczp_prime(zq)) < 0, errOut);
    ...
    cc_require_action(cc_cmp_safe_internal(32, r_computed, sig) == 0, errOut, rv = CCERR_INVALID_SIGNATURE);
