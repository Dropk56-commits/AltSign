                                           ...
                                           cche_plaintext_const_t ptext)
{
    ...
    rv = cche_ciphertext_coeff_dcrt_plaintext_mul_internal(r, ctext, dcrt_plaintext);
...
int cche_ciphertext_coeff_dcrt_plaintext_mul_internal(cche_ciphertext_coeff_t r,
                                                      cche_ciphertext_coeff_const_t ctext,
                                                      cche_dcrt_plaintext_const_t ptext)
{
    ...
    cc_require((rv = cche_ciphertext_fwd_ntt_internal(r)) == CCERR_OK, errOut);
    ...
    cc_require((rv = cche_ciphertext_inv_ntt_internal(r_eval)) == CCERR_OK, errOut);
                                             ...
                                             cche_dcrt_plaintext_const_t ptext)
{
    ...
    return cche_ciphertext_coeff_dcrt_plaintext_mul_internal(r, ctext, ptext);
}
...
static int cche_ciphertext_eval_dcrt_plaintext_mul_internal(cche_ciphertext_eval_t r,
                                            ...
                                            cche_dcrt_plaintext_const_t ptext)
{
    ...
    return cche_ciphertext_eval_dcrt_plaintext_mul_internal(r, ctext, ptext);
}
                                          ...
                                          cche_plaintext_const_t ptext)
{
    ...
    rv = cche_ciphertext_eval_dcrt_plaintext_mul_internal(r, ctext, dcrt_plaintext);
    r->correction_factor = ctext->correction_factor;
