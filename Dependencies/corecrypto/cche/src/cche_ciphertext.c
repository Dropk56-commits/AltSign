...
int cche_ciphertext_fwd_ntt_internal(cche_ciphertext_coeff_t ctext)
{
...
int cche_ciphertext_fwd_ntt(cche_ciphertext_coeff_t ctext)
{
    ...
    return cche_ciphertext_fwd_ntt_internal(ctext);
}

int cche_ciphertext_inv_ntt_internal(cche_ciphertext_eval_t ctext)
{
    CC_ASSERT_DIT_IS_ENABLED
...
int cche_ciphertext_inv_ntt(cche_ciphertext_eval_t ctext)
{
    ...
    return cche_ciphertext_inv_ntt_internal(ctext);
}
