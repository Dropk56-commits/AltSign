...
/// @details Leaks nvalues through timing. Values are encoded mod the plaintext modulus.
/// @return CCERR_OK if successful, CCERR_PARAMETER on invalid input values
CC_NONNULL_ALL CC_WARN_RESULT int cche_encode_simd_reduced_int64(cche_plaintext_t ptext,
                                                                 cche_param_ctx_const_t param_ctx,
                                                                 uint32_t nvalues,
                                                                 const int64_t *cc_counted_by(nvalues) values);
...
/// @return `CCERR_OK` if successful
CC_NONNULL_ALL CC_WARN_RESULT int cche_ciphertext_fwd_ntt_internal(cche_ciphertext_coeff_t ctext);
...
/// @return `CCERR_OK` if successful
CC_NONNULL_ALL CC_WARN_RESULT int cche_ciphertext_inv_ntt_internal(cche_ciphertext_eval_t ctext);
...
CC_NONNULL((1))
uint32_t cche_ciphertext_coeff_decompose_nptexts_internal(
    cche_ciphertext_coeff_const_t ctext,
...
CC_NONNULL((1))
CC_WARN_RESULT size_t cche_serialize_ciphertext_coeff_nbytes_internal(cche_ciphertext_coeff_const_t ctext,
...
CC_NONNULL_ALL CC_WARN_RESULT size_t cche_serialize_seeded_ciphertext_coeff_nbytes_internal(cche_ciphertext_coeff_const_t ctext);
...
/// @return `CCERR_OK` if the operation was successful
/// @details `r` and `ctext` should not overlap, unless `r == ctext`
CC_NONNULL_ALL CC_WARN_RESULT int cche_ciphertext_coeff_dcrt_plaintext_mul_internal(cche_ciphertext_coeff_t r,
                                                                                    cche_ciphertext_coeff_const_t ctext,
